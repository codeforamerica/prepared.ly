class User < ActiveRecord::Base
  ...
  attr_accessible :email, :first_name, :last_name, :phone, :address, :sms_opt_in, :password, :password_confirmation, :remember_me, :provider, :provider_id, :twitter_screen_name, :twitter_display_name, :referral_code, :admin
