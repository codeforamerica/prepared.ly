class UserMailer < ActionMailer::Base
  ...
  def welcome_email(user)
  	...
  	@facebook_share = "http://www.facebook.com/sharer.php?u=" + @referral_url.to_s
  	@tumblr_share 	= "http://www.tumblr.com/share/link?url=" + @referral_url.to_s
  	@twitter_share 	= "http://twitter.com/share?text=Check%20out%20Preparedly&url=" + @referral_url.to_s
