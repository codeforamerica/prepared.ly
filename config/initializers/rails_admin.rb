# RailsAdmin config file. Generated on May 02, 2012 07:18
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Preparedly', 'Admin']
  ...
  #     configure :preferred_contact, :boolean 
  #     configure :provider, :string 
  #     configure :twitter_screen_name, :string 
  #     configure :twitter_display_name, :string 
  #     configure :provider_id, :string 
  #     configure :referral_code, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
